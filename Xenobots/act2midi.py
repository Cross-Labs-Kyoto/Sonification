...
if __name__ == "__main__":
        ...
        while True:
            ...
            if cnt % 3 == 0:
                ...
                for idx in idxs:
                    ...
                    # TODO: Keep track of cell brightness here rather than later
    ...
    start_note = 32
    # TODO: The change in loudness is not very noticeable. Do something about it. Or remove duration (= decay mechanism).
    # TODO: Decrease decay rate
    decay_rate = 0.5
    playing = set()
    ...
    d_t = second2tick(3/fps, ticks_per_beat=480, tempo=500000)
    for note in playing:
        track.append(Message('note_off', channel=1, note=note, velocity=32, time=d_t))
        d_t -= d_t
